            ...
            <form:form method="post" action="save" modelAttribute="worker">
                ...
                <div class="d-flex">
                    <div class="flex-fill m-2">
                        ...
                        <div class="form-group rounded-lg">
                            ...
                            <form:input class="form-control" type="text" id="company-street"
                    ...
                    <div class="flex-fill m-2">
                        ...
                        <div class="form-group">
                            ...
                            <form:input class="form-control" type="text" id="company-number"
                ...
                <div class="mx-2 mt-2">
                    ...
                    <a class="ml-3 btn btn-light border-secondary"
                       href="${pageContext.request.contextPath}/worker/list">Cancle</a>
                </div>
            </form:form>
        </div>
    </jsp:body>
