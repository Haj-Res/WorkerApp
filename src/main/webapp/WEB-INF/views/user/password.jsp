...
<t:genericpage pageName="User profile"
    ...
    <jsp:body>
        <form:form action="process-password" method="post" modelAttribute="password"
            ...
            <div class="form-group mt-2">
                <label for="email">Confirm Old Password</label>
                <form:errors path="oldPassword" cssClass="error"/>
                <form:password path="oldPassword" class="form-control" id="email"/>
            </div>
            <div class="d-flex flex-row mt-4">
                <input class="btn btn-secondary mr-3" type="submit" value="Save"/>
                <a class="btn btn-outline-secondary" href="${pageContext.request.contextPath}/user/profile">Cancel</a>
            </div>
        </form:form>
    </jsp:body>
</t:genericpage>
